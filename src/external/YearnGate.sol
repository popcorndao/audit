...
contract BeefyWrapper is YearnV1_4626 {
    ...
    constructor(address _vault, address _dustWallet)
        ERC20("Beefy-4646-Adapter", "Beefy-4646")
        YearnV1_4626(_dustWallet)
    {
        ...
        IERC20(token).approve(address(yVault), type(uint256).max);
    }
   ...
   //////////////////////////////////////////////////////////////*/
        ...
        returns (uint256 adjustedAmount)
    {
        BeefyAPI _vault = yVault;
        {
            ...
            uint256 fee = strat.withdrawalFee();
            uint256 DIVISOR = strat.WITHDRAWAL_MAX();
