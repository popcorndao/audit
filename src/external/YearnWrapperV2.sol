    ...
    ReentrancyGuard
{
    ...
    function migrate(address _target) external onlyOwner returns (address) {
        ...
        uint256 assets = yVault.withdraw(type(uint256).max);
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function withdraw(
        ...
        (assets, shares) = _withdraw(assets, receiver, owner);
    ...
    function redeem(
        ...
        (assets, shares) = _redeem(shares, receiver, owner);
  ...
  //////////////////////////////////////////////////////////////*/
    ...
    function _withdraw(
        ...
        uint256 yearnShares = convertAssetsToYearnShares(amount);
    ...
    function _redeem(
        ...
        VaultAPI _vault = yVault;
        uint256 yearnShares = convertSharesToYearnShares(shares);
        assets = _doWithdrawal(shares, yearnShares, sender, receiver, _vault);
        sharesBurnt = shares;
    }
    ...
    function convertAssetsToYearnShares(uint256 assets)
        internal
        view
        returns (uint256 yShares)
    {
        ...
        return
            supply == 0
                ? assets
                : assets.mulDivUp(10**decimals(), yVault.pricePerShare());
    }

    function convertYearnSharesToAssets(uint256 yearnShares)
        internal
        view
        returns (uint256 assets)
    {
        ...
        return
            supply == 0
                ? yearnShares
                : (yearnShares * yVault.pricePerShare()) / 10**decimals();
    }

    function convertSharesToYearnShares(uint256 shares)
        internal
        view
        returns (uint256 yShares)
    {
