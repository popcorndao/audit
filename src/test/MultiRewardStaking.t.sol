...
contract MultiRewardStakingTest is Test {
    ...
    function test__accrual() public {
        ...
        (, , , index, lastUpdatedTimestamp) = staking.rewardInfos(
            iRewardToken1
        );
    ...
    function test__accrual_multiple_rewardsToken() public {
        ...
        (, , , indexReward1, lastUpdatedTimestampReward1) = staking.rewardInfos(
            iRewardToken1
        );
        ...
        ) = staking.rewardInfos(iRewardToken2);
        ...
        (, , , indexReward2, lastUpdatedTimestampReward2) = staking.rewardInfos(
            iRewardToken2
        );
    ...
    function test__accrual_with_user_joining_later() public {
        ...
        assertEq(staking.userIndex(alice, iRewardToken1), index);
        assertEq(
            staking.accruedRewards(alice, iRewardToken1),
            3333333333333333333
        );

        assertEq(staking.userIndex(bob, iRewardToken1), index);
        assertEq(
            staking.accruedRewards(bob, iRewardToken1),
            4666666666666666666
        );
    ...
    function _addRewardTokenWithZeroRewardsSpeed(MockERC20 rewardsToken)
        internal
    {
        staking.addRewardToken(
            IERC20(address(rewardsToken)),
    ...
    function test__addRewardToken() public {
        ...
        (
            ...
            uint32 offset
        ) = staking.escrowInfos(iRewardToken1);
    ...
    function test__addRewardToken_end_time_not_affected_by_other_transfers()
        public
    {
        // Prepare to transfer reward tokens
        ...
        (, , uint32 rewardsEndTimestamp, , ) = staking.rewardInfos(
            iRewardToken1
        );
        assertEq(uint256(rewardsEndTimestamp), callTimestamp + 100);
