...
contract PropertyTest is EnhancedTest {
    ...
    function prop_previewDeposit(
        ...
        assertApproxGeAbs(sharesActual, sharesPreview, _delta_, testPreFix);
    }
    ...
    function prop_previewMint(
        ...
        assertApproxLeAbs(assetsActual, assetsPreview, _delta_, testPreFix);
    }
    ...
    function prop_previewWithdraw(
        ...
        assertApproxLeAbs(actual, preview, _delta_, testPreFix);
    }
    ...
    function prop_previewRedeem(
        ...
        assertApproxGeAbs(actual, preview, _delta_, testPreFix);
    }
