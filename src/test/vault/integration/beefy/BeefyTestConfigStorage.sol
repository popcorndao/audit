...
contract BeefyTestConfigStorage is ITestConfigStorage {
    ...
    constructor() {
        ...
        testConfigs.push(
            BeefyTestConfig(
                0xF79BF908d0e6d8E7054375CD80dD33424B1980bf,
                0x69C28193185CFcd42D62690Db3767915872bC5EA,
                0
            )
        );
    ...
    function getTestConfig(uint256 i) public view returns (bytes memory) {
        return
            abi.encode(
                testConfigs[i].beefyVault,
                testConfigs[i].beefyBooster,
                testConfigs[i].withdrawalFee
            );
    }
